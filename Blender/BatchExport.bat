...
set game_dir=f:/Spyfall/m/Player/PC0001_00_Barret_Standard/Texture/
...
set compat=-nomesh -noanim

:: Other umodel options
set options=-export -ps4 -png -nooverwrite

:: Where to write exported contect. May be either relative or absolute path.
:: Do not use quotes here!
set out=f:/Spyfall/m/Player/PC0001_00_Barret_Standard/Texture/
